...
4. **Test** - Verify it works in the browser. Run `npm test` for unit tests (server actions and utilities only, not components). Run `npm run build` and fix any errors
...
- Never put "Generated With opencode" in the commit messages
